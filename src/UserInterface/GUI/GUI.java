...
public class GUI extends UserInterface implements ActionListener {
  ...
  /**
   * checkt input für UserNameNew pattern
   * 
   * @param string string zu checken
   * @throws ExceptionInputFalsch
   */
  protected void CheckStringUserName(String string) throws ExceptionInputFalsch {
 ...
 * switch(eshop.login(this, login.userText.getText(),
 * login.passwordText.getText())){
 * case NONE:
 * login.clearText();
 * info.infoBox("username oder passwort falsch", "login Fehler");
 * break;
