...
public class GUI extends UserInterface implements ActionListener {
  ...
  public void actionPerformed(ActionEvent ae) {
      switch (ae.getActionCommand()) {
        ...
        case "mitarbeiter_EreignisSuchen":
          ...
          if(searchterm.equals("")){resetEventLog();}
          else{
            try {
        ...
        case "Edit_ArtikelErstellen":
          ...
          try {
            ...
            edit.frame.dispose();
          } catch (ExceptionArtikelExistiertBereits | ExceptionArtikelKonnteNichtErstelltWerden | ExceptionInputFalsch e) {
            info.infoBox(e.getMessage(), "Fehler");
          }
          updateArtikel();
          break;    
        ...
        selectedArticle = (Artikel) artikelList.get(employ.shopTable.getSelectedRow());
          try {
            ...
            edit.frame.dispose();
          } catch (NumberFormatException | ExceptionArtikelNichtGefunden | ExceptionArtikelUngültigerBestand | ExceptionInputFalsch e) {
            info.infoBox(e.getMessage(), "Fehler");
          }
          updateArtikel();
          break;
        ...
        case "Edit_MitarbeiterHinzufügen":
          try {
            eshop.BV_mitarbeiterHinzufügen(CheckStringNamen(edit.nutzerNameText.getText()), CheckStringUsername(edit.usernameText.getText()), CheckStringPasswort(edit.passwordText.getText()));
            updateNutzer();
  ...
  /**
   * Sortiert die Artikelliste bzw erschafft neue Ordnung basierend auf suchbegriff und Filter
   * @param searchTerm
   * @param filter
   */
  ...
  //update Shopansicht mit Vorsortierter Artikel Liste --> wenn SUchbegriff eingegeben
  ...
  /**
   * resetet Suchbegriff, Filter, und Shopansicht --> einfache ausgabe aller artikel 
   */
  ...
  */
   ...
   * @param sichtbar String, welches Panel ist sichtbar? "login", "kunde", "mitarbeiter", "register"
   */
